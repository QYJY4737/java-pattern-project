...
/**
 * 随机生成中文姓名，性别，Email，手机号，地址
 *
 * @Author: yang
 * @Date: 2020-12-14 1:50
 */
public class RandomValue {
     ...
     */
    public static char calcTrailingNumber(StringBuilder sb) {
        int[] n = new int[17];
        int result = 0;
    ...
    public static void main(String[] args) {
        for (int i = 0; i < 100; i++) {
            ...
            cn.congee.api.entity.RandomValue randomValue = cn.congee.api.entity.RandomValue.builder()
                    ...
                    .email(getEmail(6, 9))
                    .build();
            String xml = JaxbUtil.convertToXml(randomValue, "UTF-8");
            System.out.println("第" + (i+1) + "次随机生成中文姓名，性别，Email，手机号，地址的结果为: " + "\n" + xml);
