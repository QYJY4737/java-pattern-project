package cn.congee.api.others.verifiycode;
...
/**
 * 用java实现Graphics2D绘制验证码功能
 *
 * @Author: yang
 * @Date: 2020-12-12 7:11
 */
public class DrawGraphics {
    ...
    public static void drawRandomLine(Graphics g){
        ...
        for (int i = 0; i < 3; i++){
            ...
            int y2 = new Random().nextInt(WIDTH) + HEIGHT / 2;
